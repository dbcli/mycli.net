...
Mycli is a user-friendly commandline client for MySQL, MariaDB, Percona, and
TiDB. It has unique features like autocompletion and syntax highlighting that
make it easy to use.
...
cross-platform compatible and is tested on Linux and macOS.

My is developed by a team of core devs from around the world. The
user-friendliness is not just limited to the tool — the mycli community is
friendly and welcoming to newcomers.

The founding author is [Amjith Ramanujam](https://github.com/amjith).
