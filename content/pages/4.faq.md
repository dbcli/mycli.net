...
1. **How did it all begin?**
    ...
    Earlier this year I (Amjith) wrote [pgcli](https://pgcli.com) to scratch my own itch.
    ...
    [BPython](https://www.bpython-interpreter.org/), I fell in love with it.
    ...
    Terminals](https://en.wikipedia.org/wiki/Computer_terminal#Dumb_terminals).
...
1. **Does mycli work on Windows?**
    ...
    unit-tests do not all pass on a Windows environment. So if things break
    please [report](https://github.com/dbcli/mycli/issues) them.

1. **Will there be an equivalent of this for Sqlite/Postgresql?**

    There are already equivalents for Postgres and SQLite! Check out:

    * [https://pgcli.com](https://pgcli.com)
    * [https://litecli.com](https://litecli.com)
...
1. **How is the Smart Completion implemented?**
    ...
    category. In those scenarios, you may want to turn it off (using the F2 key) and
...
1. **I found a bug, what do I do?**
    ...
    Whoopsie Daisies! We're sorry you encountered a bug. Please file a bug on
    [Github Issues] for this project.

1. **I have a feature request, what do I do?**

    Sweet! Open a new item on [Github Issues]. Alternatively, you can take a stab
    at implementing the new feature yourself.

1. **I want to contribute to this project, how do I do that?**

    Awesome! We thought you'd never ask! Here's a [developer
    guide](https://github.com/dbcli/mycli/blob/main/CONTRIBUTING.md) which provides
    basic info on getting started with local development.
